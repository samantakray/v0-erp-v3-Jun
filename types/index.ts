...
export interface StoneLotData {
  id: string
  lot_number: string
  stone_type: string // This will store the code, e.g., "KW"
  stone_size: string
  quantity: number
  weight: number
  available: boolean
  ...
  type?: StoneCut // This corresponds to the stone cut
...
// Type for creating a new stone lot, omitting database-generated fields
export type NewStoneLotData = Omit<StoneLotData, "id" | "created_at" | "status" | "available">
...
export interface DiamondLotData {
  ...
  a_type?: DiamondType // As per schema
...
// Type for creating a new diamond lot, omitting database-generated fields
export type NewDiamondLotData = Omit<DiamondLotData, "id" | "status">;
