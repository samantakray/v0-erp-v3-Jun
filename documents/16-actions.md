...
3. Prepares phase-specific data for storage
4. Updates the job record
5. Adds a job history entry
6. Updates the parent order status based on all job statuses
7. Revalidates relevant paths
